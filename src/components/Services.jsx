  ...
  return (
    <Section id="how-to-use">
      <div className="container">
        <Heading
          title="Generative AI made for for EveryOne."
          text="Mees unlocks the potential of AI-powered applications"
        />
              ...
              <ul className="body-2">
                {brainwaveServices.map((item, index) => (
                  ...
                  >
                    ...
                    <p className="ml-4"><a href="https://mees-ai-search.vercel.app/">{item}</a></p>
                  </li>
                ))}
              </ul>
            </div>
